...
:class:`ip3r.render.scene.Scene`, so lighting and depth cueing stay
...
:meth:`ip3r.ui.gl_widget.ViewportWidget._on_tick` catches by *unregistering
...
class CylinderBatch(Batch):
    ...
    **Never culled.** The bounding quad is built around the cylinder's own axis,
    ...
    #: Read by :meth:`ip3r.render.scene.Scene.render`.
    cull = False
