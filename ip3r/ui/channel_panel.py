...
class ChannelPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.lumen_box = LumenControls(self)
        self.show_lumen = self.lumen_box.show
        self.lumen_info = self.lumen_box.info
        self.lumen_box.toggled.connect(self.lumen_toggled.emit)
        lay.addWidget(self.lumen_box)
    ...
    def show_lumen_field(self, f, s, charged=None) -> None:
