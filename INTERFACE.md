...
| `cli_ryr.py` | the RyR1 commands, `register(sub)`: `mutants`, `ryr-gating`, `sparks [--scan] [--cleft [--fit]]`, `spark-termination [--scan fit\|ki\|rate\|use\|ratio\|fraction\|low-activity] [--bell] [--fitted]`, `spark-mg [--scan] [--reading R] [--spontaneous] [--two-site]`, `ec [--scan] [--reading R] [--only S] [--trials N] [--two-site] [--use] [--depletion [--pool-scan] [--large]]` |
